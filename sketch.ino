...
//Rev4: 13-09-2026 Configuração do broker MQTT com IP da instância AWS EC2 e ajuste 
//da entidade para lamp200/fiware_200, conforme PoC Smart Lamp do CP4
//Autor Rev4: Isac Oliveira
#include <WiFi.h>
